<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ darkMode: false }" x-init="darkMode = localStorage.getItem('theme') === 'dark' || (!localStorage.getItem('theme') && window.matchMedia('(prefers-color-scheme: dark)').matches)" :class="{ 'dark': darkMode }">
<head>
    <meta charset="utf-8">
...
<body class="font-inter bg-gray-50 dark:bg-zinc-900 min-h-screen text-gray-900 dark:text-zinc-100 antialiased" 
    ...
    <!-- Desktop Sidebar -->
    <div id="sidebar" style="margin: 0.5rem 0 0.5rem 0.5rem;"
         :class="{ 'w-56': !sidebarCollapsed, 'w-16': sidebarCollapsed }"
         class="fixed inset-y-0 left-0 z-50 bg-white rounded-lg dark:bg-zinc-800 shadow-lg border-r border-gray-200 dark:border-zinc-700 hidden lg:block transition-all duration-300 ease-in-out">
        ...
        <div class="flex items-center h-16 px-4 border-b border-gray-200 dark:border-zinc-700">
            ...
            <button @click="toggleSidebar()" 
                    :class="{ 'ml-auto': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }"
        ...
        <nav class="mt-2 px-3 space-y-1">
            ...
            <a href="{{ route('dashboard') }}" 
               ...
               class="@if(request()->routeIs('dashboard')) bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-300 border-r-2 border-primary-500 @else text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 @endif group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">dashboard</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
            ...
            <a href="#" 
               class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">swap_horiz</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
            ...
            <a href="#" 
               class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">pie_chart</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
            ...
            <a href="#" 
               class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">category</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
            ...
            <a href="#" 
               class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">flag</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
            ...
            <a href="#" 
               class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                <span class="material-icons flex-shrink-0" :class="{ 'mr-3': !sidebarCollapsed, 'mx-auto': sidebarCollapsed }">psychology</span>
                <span x-show="!sidebarCollapsed" 
                      x-transition:enter="transition ease-in-out duration-300 delay-75"
                      x-transition:enter-start="opacity-0"
                      x-transition:enter-end="opacity-100"
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-zinc-700">
            <div class="flex items-center space-x-3" :class="{ 'justify-center': sidebarCollapsed }">
                ...
                <div x-show="!sidebarCollapsed" 
                    ...
                    <p class="text-sm font-medium text-gray-900 dark:text-zinc-100 truncate">{{ auth()->user()->name }}</p>
    ...
    <div x-show="mobileMenuOpen" 
         ...
         class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-zinc-800 shadow-lg lg:hidden"
         style="display: none;">
        ...
        <nav class="mt-4 px-4 space-y-2">
            ...
            <a href="#" @click="mobileMenuOpen = false" class="text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-zinc-100 group flex items-center px-4 py-3 text-sm font-medium rounded-lg">
    ...
    <!-- Main Content -->
    <div :class="{ 'lg:ml-56 ml-2': !sidebarCollapsed, 'lg:ml-16': sidebarCollapsed }" 
         class="transition-all duration-300 ease-in-out ">
        
        <!-- Top Navigation Bar -->
        <nav class="bg-white mt-2 ml-4 dark:bg-zinc-800 rounded-lg  shadow-sm border-b border-gray-200 dark:border-zinc-700 lg:border-b-0 lg:shadow-none">
            <div class="px-4 lg:px-6 py-3 lg:py-2">
                <div class="flex items-center justify-between">
                    ...
                    <nav aria-label="breadcrumb" class="hidden lg:block">
                        <ol class="flex items-center space-x-2 text-sm">
                            <li>
                                <a href="#" class="text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200">Páginas</a>
                            </li>
                            <li class="text-gray-400 dark:text-zinc-500">/</li>
                            <li class="text-gray-900 dark:text-zinc-100 font-medium">{{ $pageTitle ?? 'Dashboard' }}</li>
                        </ol>
                    </nav>

                    <!-- Mobile Page Title -->
                    <h1 class="lg:hidden text-lg font-semibold text-gray-900 dark:text-zinc-100">{{ $pageTitle ?? 'Dashboard' }}</h1>
                    ...
                    <div class="flex items-center space-x-2 lg:space-x-4">
                        ...
                        <div class="hidden lg:block relative">
                            ...
                            <span class="absolute right-3 top-1/2 transform -translate-y-1/2 material-icons text-gray-400 text-lg">search</span>
                        </div>
                        ...
                        <button @click="toggleTheme()" 
                            ...
                            <span class="material-icons text-lg" x-text="darkMode ? 'light_mode' : 'dark_mode'"></span>
                        </button>

                        <!-- Notifications -->
                        <div class="relative">
                            <button class="p-2 text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-lg transition-colors">
                        ...
                        <!-- Settings -->
                        <button class="hidden lg:block p-2 text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-lg transition-colors">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" 
                                ...
                                <span class="hidden lg:block material-icons text-gray-500 dark:text-zinc-400 text-sm">keyboard_arrow_down</span>
                            </button>
    ...
    <div class="fixed bottom-6 right-6 lg:hidden z-40">
        <button class="w-14 h-14 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full shadow-lg flex items-center justify-center text-white hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all">
